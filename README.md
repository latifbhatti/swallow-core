...
```sh
git clone git@github.com:merledu/Scala-Chisel-Learning-Journey.git
cd Scala-Chisel-Learning-Journey
```
...
#### Commit your changes
```sh
git commit -m 'Starting Scala-Chisel-Learning-Journey'
